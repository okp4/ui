  ...
  {args => {
    ...
    const handleReset = useCallback(() => {
      ...
      dispatch({
        type: 'stepperReset',
        payload: {
          initialCurrentStepId: 'TMPd6bsSkUiTauLbHa0aWw',
...
const { state, dispatch } = useStepper(
  'DcKIvKNG1EOhV-oHJb85PA', // The initial current step id
...
const handleReset = useCallback(() => {
  dispatch({
    ...
    payload: {
      initialCurrentStepId: 'eIi90zMum0SYOW-GPn7AOg',
      initialStepsStatus: steps.map(step => ({ id: step.id, status: step.status }))
    }
  })
}, [dispatch, steps])
    ...
    {() => {
      ...
      const handleReset = useCallback(() => {
        dispatch({
          type: 'stepperReset',
          payload: {
            initialCurrentStepId: 'Ppi_Ewca7kO8XPkJooI9jA',
            initialStepsStatus: steps.map(step => ({ id: step.id, status: step.status }))
          }
        })
      }, [dispatch, steps])
    ...
    {() => {
      ...
      const handleReset = useCallback(() => {
        dispatch({
          type: 'stepperReset',
          payload: {
            initialCurrentStepId: 'vFsGhDsnZEK0IqB2Y2VaEQ',
            initialStepsStatus: steps.map(step => ({ id: step.id, status: step.status }))
          }
        })
      }, [dispatch, steps])
    ...
    {() => {
      ...
      const handleReset = useCallback(() => {
        dispatch({
          type: 'stepperReset',
          payload: {
            initialCurrentStepId: 'N5sSREHzwkW5HivBG6xG_g',
            initialStepsStatus: steps.map(step => ({ id: step.id, status: step.status }))
          }
        })
      }, [dispatch, steps])
    ...
    {() => {
      ...
      const handleReset = useCallback(() => {
        dispatch({
          type: 'stepperReset',
          payload: {
            initialCurrentStepId: '9CSubVYzIky5BQgM2eNUVQ',
            initialStepsStatus: steps.map(step => ({ id: step.id, status: step.status }))
          }
        })
      }, [dispatch, steps])
    ...
    {() => {
      ...
      const handleReset = useCallback(() => {
        dispatch({
          type: 'stepperReset',
          payload: {
            initialCurrentStepId: 'zxnPnxshjUCmQHi9HF9KXA',
            initialStepsStatus: steps.map(step => ({ id: step.id, status: step.status }))
          }
        })
      }, [dispatch, steps])
    ...
    {() => {
      ...
      const handleReset = useCallback(() => {
        dispatch({
          type: 'stepperReset',
          payload: {
            initialCurrentStepId: 'DXHjI4R2_U64-hYFhrmbLw',
            initialStepsStatus: steps.map(step => ({ id: step.id, status: step.status }))
          }
        })
      }, [dispatch, steps])
    ...
    {() => {
      ...
      const handleReset = useCallback(() => {
        dispatch({
          type: 'stepperReset',
          payload: {
            initialCurrentStepId: '3-rsCn8oPkyj1DDMlCfu3A',
    ...
    {() => {
      ...
      const handleReset = useCallback(() => {
        ...
        dispatch({
          type: 'stepperReset',
          payload: {
            initialCurrentStepId: 'UOfvE34NWU2vXiMgLVx6Dw',
            initialStepsStatus: steps.map(step => ({ id: step.id, status: step.status }))
          }
        })
      }, [dispatch, steps])
