...
The property `multiline` allows to write a more text on several lines. The simple text field becomes a text area.  
...
If the text field is multiline, the property `numberOfRows` defines the initial heigth of the text field.

<Canvas isColumn>
  <Story name="Number of rows">
    <div
      style={{
        display: 'flex',
        flexDirection: 'column',
