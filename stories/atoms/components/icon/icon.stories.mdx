...
reducing the need for text that can be hard to read and less intuitive.<br />
...
The **size** is squared and can be adjusted by passing a number value.<br />
...
The **className** property allows you to style the svg with css properties.<br />
