...
- the file name must be the same, so here it will be `languageSwitcher_en.json`
- the file format must be identical (same key names, curly brackets...)
- translation can be replaced by your own
- new key with associated translation can be added

##### **`languageSwitcher_en.json`**

```json
{
  "languages": "Update with your own translation here", // Translation replacement
  "modify-language": "Write your own translation here" // New key with associated translation insertion
}
```
