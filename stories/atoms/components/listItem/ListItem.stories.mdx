...
<Story
  ...
  args={{
    ...
    leftElement: <Icon name="wallet" invert />,
    rightElement: <Icon name="close" invert />
  }}
>
  {args => <ListItem {...args} />}
</Story>
            ...
            <ListItem
              ...
              leftElement={
                <Button
                  ...
                  size="small"
                  variant="icon"
                  icon={<Icon name="cross" size="15" invert />}
