...
From a React point of view, `Atoms` are *Dumb components*, also called *presentational* components, because their only 
...
From a React point of view, `Organisms` are *Smart components*, since they manipulate data, interact with the outside and manage a state.
